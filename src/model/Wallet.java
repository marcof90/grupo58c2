...
public class Wallet {
    ...
    public static final int CAPACIDAD_MAXIMA = 1000000;  //las constantes son publicas
    ...
    //metodos es lo mismo que funciones en python y por lo general son publicos. Y el tipo de dato que uno quiere traer, ese es el que pone
    // ej saldo, es entero, entonces el metodo es int
